...
int adventurerEffect(struct gameState *state, int currentPlayer, int drawntreasure, int cardDrawn, int* temphand)
{
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  {
    case adventurer:
      return adventurerEffect(state, currentPlayer, drawntreasure, cardDrawn, *temphand);
			
    case council_room:
      return council_roomEffect(state, currentPlayer, handPos);
			
    case feast:      			
      return feastEffect(state, currentPlayer, temphand, choice1);
