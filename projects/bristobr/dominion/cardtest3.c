...
const int fillCard[] = {gardens, copper, village};
  int fillCardLength = 3;
  int fillCardIdx_1 = 0;
  int fillCardIdx_2 = 0;
  int fillCardIdx_3 = 0;

 const  int numPlayers[] = {2, MAX_PLAYERS};
  int numPlayersLength =2;
  int numPlayersIdx = 0;

  const int handCount[] = {1, 5, MAX_HAND};
  int handCountLength = 3;
  int handCountIdx = 0;

  const int deckCount[] = {0, 5, MAX_DECK};
  int deckCountLength = 3;
  int deckCountIdx = 0;
printf("%d, %d, %d\n", MAX_PLAYERS, MAX_HAND, MAX_DECK);
...
//printf("%d, %d, %d, %d, %d, %d\n", numPlayersIdx, fillCardIdx_1, handCountIdx, fillCardIdx_2, deckCountIdx, fillCardIdx_3);
printf("Constructing new state:\n\tnumPlayers: %d\n\t handCount: %d\n\t deckCount: %d\n\t", numPlayers[numPlayersIdx], handCount[handCountIdx], deckCount[deckCountIdx]);
